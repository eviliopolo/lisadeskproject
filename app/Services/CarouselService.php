...
class CarouselService
{
    ...
    public function __construct()
    {
        ...
        $this->items[]= [
            "src" => "vendor/wrappixel/material-pro/4.1.0/assets/images/big/img6.jpg",
        ...
        $this->items[] = [
            "src" => "vendor/wrappixel/material-pro/4.1.0/assets/images/big/img3.jpg",
        ...
        $this->items[] = [
            "src" => "vendor/wrappixel/material-pro/4.1.0/assets/images/big/img4.jpg",
